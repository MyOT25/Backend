...
*/
-- AlterTable
ALTER TABLE `Community` ADD COLUMN `musicalName` VARCHAR(191) NULL,
    ADD COLUMN `recentPerformanceDate` DATETIME(3) NULL,
    ADD COLUMN `theaterName` VARCHAR(191) NULL,
    ADD COLUMN `ticketLink` VARCHAR(191) NULL;
